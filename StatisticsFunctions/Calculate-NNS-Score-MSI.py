...
PREDICTION_PATH = "H:/Masters-Thesis/ModelOutputs/MSI-Net-Trained"
DATASET_PATH = "H:/Masters-Thesis/masters-thesis-middleware/Dataset/No/saliency"
...
def scoreDataset():
    start = time.time()
    f = open("msi-result-trained-no.txt", "w")
    f.write(PREDICTION_PATH + "\n")
    nssScores = []
    for category in os.listdir(DATASET_PATH):
        for image in os.listdir(DATASET_PATH + "/" + category):
